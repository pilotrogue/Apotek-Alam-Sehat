...
Public Class FPm_BukuBesarPembantuUtang
    ...
    Private Sub FPm_BukuBesarPembantuUtang_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        init.koneksi()
        ...
        dataAdapter.Fill(dataSet, "PEMBANTU_UTANG")
