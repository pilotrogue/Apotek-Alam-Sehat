...
Public Class FPm_BukuBesarDiskon
    ...
    Private Sub FPm_BukuBesarDiskon_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        init.koneksi()
        ...
        dataAdapter.Fill(dataSet, "DISKON")
