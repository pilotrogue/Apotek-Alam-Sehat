...
Public Class FPm_LaporanStokAkhir
    Private Sub BtnHome_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnHome.Click
        'Me.Hide()
        'FUser_KAGudang.Show()
    End Sub

    Private Sub FPm_LaporanStokAkhir_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        init.koneksi()
        ...
        dataAdapter.Fill(dataSet, "LAPORAN_STOK_TERSISA")
